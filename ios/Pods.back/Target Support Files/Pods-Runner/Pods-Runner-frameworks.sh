...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_isolate/flutter_isolate.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_user_agent/flutter_user_agent.framework"
